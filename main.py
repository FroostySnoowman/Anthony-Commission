...
class AnthonyBot(commands.Bot):
    def __init__(self):
        super().__init__(command_prefix=commands.when_mentioned_or('.'), owner_ids=[503641822141349888, 700783934325260428], intents=intents, activity=_activity, status=_status)
